...
const CUSTOMER_FAQS: FAQItem[] = [
    {
        question: 'How do I book a care package?',
        answer: 'Go to the Home tab, select a package category (Mother Care, Baby Care, or Muma Care), pick a subscription duration (1, 3, or 6 months), fill in your scheduling details, and complete the checkout process.',
    },
    {
        question: 'Can I choose my appointment dates and times?',
        answer: 'Yes! During checkout, you can select your starting date from the next 14 calendar days, choose a convenient slot (Morning, Afternoon, Evening), and pick a specific time from the admin-configured options.',
    },
    {
        question: 'How can I request a cancellation or refund?',
        answer: 'Please contact our support team directly using the email or phone helpline buttons above. We process eligible refunds within 5-7 business days.',
    },
    {
        question: 'What qualifications do caregivers have?',
        answer: 'Every care professional on Muma Care undergoes strict background verification, profile checks, and specialized training in mother and newborn baby care.',
    },
    {
        question: 'How do I update my profile or address details?',
        answer: 'Navigate to "My Account", edit your details in the Profile tab, or add and delete items in the Addresses tab.',
    },
];
...
const HelpSupportScreen: React.FC<Props> = ({ navigation }) => {
    ...
    const handleEmailSupport = async () => {
        const url = 'mailto:support@mumacare.com?subject=Customer%20Support%20Request';
        try {
            const canOpen = await Linking.canOpenURL(url);
            if (canOpen) {
                await Linking.openURL(url);
        ...
        <SafeAreaView style={styles.safe}>
            ...
            <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.banner}>
                    <Icon name="headset" size={40} color={Colors.PRIMARY} style={{ marginBottom: 12 }} />
                    <Text style={styles.bannerTitle}>How can we help you?</Text>
                    <Text style={styles.bannerSubtitle}>
                        Get in touch with the Muma Care team or browse answers to common questions below.
                    </Text>
                </View>
                ...
                <View style={styles.contactRow}>
                    ...
                    <TouchableOpacity style={styles.contactCard} onPress={handleEmailSupport} activeOpacity={0.85}>
                        ...
                        <Text style={styles.contactValue}>support@mumacare.com</Text>
                    </TouchableOpacity>
                </View>
